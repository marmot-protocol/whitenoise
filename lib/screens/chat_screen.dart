...
import 'package:whitenoise/utils/encoding.dart' show npubFromHex;
...
Future<List<_MentionMember>> _loadMentionMembers({
  ...
  final mentionablePubkeys = {...pubkeys}.where((pubkey) => pubkey != currentUserPubkey).toList();
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            Widget bubble = ChatMessageBubble(
              ...
              nostrDisplayNamesByUri: mentionDisplayNamesByUri,
              isOwnMessage: isOwnMessage,
              currentUserPubkey: pubkey,
