...
Future<LoginResult>  loginStart({required String nsecOrHexPrivkey }) => RustLib.instance.api.crateApiAccountsLoginStart(nsecOrHexPrivkey: nsecOrHexPrivkey);

Future<LoginResult>  loginPublishDefaultRelays({required String pubkey }) => RustLib.instance.api.crateApiAccountsLoginPublishDefaultRelays(pubkey: pubkey);

Future<LoginResult>  loginWithCustomRelay({required String pubkey , required String relayUrl }) => RustLib.instance.api.crateApiAccountsLoginWithCustomRelay(pubkey: pubkey, relayUrl: relayUrl);

Future<void>  loginCancel({required String pubkey }) => RustLib.instance.api.crateApiAccountsLoginCancel(pubkey: pubkey);
...
Future<bool>  isFollowingUser({required String accountPubkey , required String userPubkey }) => RustLib.instance.api.crateApiAccountsIsFollowingUser(accountPubkey: accountPubkey, userPubkey: userPubkey);

Future<AccountSettings>  accountSettings({required String pubkey }) => RustLib.instance.api.crateApiAccountsAccountSettings(pubkey: pubkey);

Future<AccountSettings>  updateNotificationsEnabled({required String pubkey , required bool enabled }) => RustLib.instance.api.crateApiAccountsUpdateNotificationsEnabled(pubkey: pubkey, enabled: enabled);
...
final DateTime updatedAt;
                ...
                const Account({required this.pubkey ,required this.accountType ,this.lastSyncedAt ,required this.createdAt ,required this.updatedAt ,});
        ...
        @override
        int get hashCode => pubkey.hashCode^accountType.hashCode^lastSyncedAt.hashCode^createdAt.hashCode^updatedAt.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is Account &&
                ...
                && pubkey == other.pubkey&& accountType == other.accountType&& lastSyncedAt == other.lastSyncedAt&& createdAt == other.createdAt&& updatedAt == other.updatedAt;
...
class AccountSettings  {
                ...
                const AccountSettings({required this.notificationsEnabled ,});
...
final LoginStatus status;
                ...
                const LoginResult({required this.account ,required this.status ,});
        ...
        bool operator ==(Object other) =>
            ...
            other is LoginResult &&
                runtimeType == other.runtimeType
                && account == other.account&& status == other.status;
