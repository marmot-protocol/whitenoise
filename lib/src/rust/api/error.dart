...
const factory ApiError.whitenoise({   required String message , }) = ApiError_Whitenoise;
 ...
 const factory ApiError.loginInvalidKeyFormat({   required String message , }) = ApiError_LoginInvalidKeyFormat;
 const factory ApiError.loginNoRelayConnections() = ApiError_LoginNoRelayConnections;
 const factory ApiError.loginTimeout({   required String message , }) = ApiError_LoginTimeout;
 const factory ApiError.loginNoLoginInProgress() = ApiError_LoginNoLoginInProgress;
 const factory ApiError.loginInternal({   required String message , }) = ApiError_LoginInternal;
 const factory ApiError.loginKeyringUnavailable({   required String message , }) = ApiError_LoginKeyringUnavailable;
