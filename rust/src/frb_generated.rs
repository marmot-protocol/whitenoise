...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        21 => wire__crate__api__drafts__delete_draft_impl(port, ptr, rust_vec_len, data_len),
        22 => wire__crate__api__media_files__download_chat_media_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        23 => wire__crate__api__relays__ensure_all_subscriptions_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        25 => wire__crate__api__messages__fetch_aggregated_messages_for_group_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        26 => wire__crate__api__accounts__follow_user_impl(port, ptr, rust_vec_len, data_len),
        27 => wire__crate__api__accounts__get_account_impl(port, ptr, rust_vec_len, data_len),
        28 => wire__crate__api__account_groups__get_account_group_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        29 => wire__crate__api__relays__get_account_relay_statuses_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        30 => wire__crate__api__accounts__get_accounts_impl(port, ptr, rust_vec_len, data_len),
        31 => wire__crate__api__get_app_settings_impl(port, ptr, rust_vec_len, data_len),
        32 => wire__crate__api__chat_list__get_chat_list_impl(port, ptr, rust_vec_len, data_len),
        33 => wire__crate__api__utils__get_default_blossom_server_url_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
